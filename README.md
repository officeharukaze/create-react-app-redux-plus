create-react-app で作ったプロジェクトに React+Redux を組み込んでみた
---

自分用のテンプレートですが、困ってる人もいるかもしれないので公開しておきます。<br>
ついでにディレクトリ整理をして管理をしやすくしてます。<br>
Chromeに Redux Dev Toolsを入れておくとステートのデバックもできます<br>

## 実行手順
```yarn install && yarn start```

[参考サイト] http://qiita.com/MegaBlackLabel/items/df868e734d199071b883
